...
[PowerShell Direct](../user-guide/powershell-direct.md) es un ejemplo de aplicación (en este caso un servicio de Windows incorporado) que usa sockets de Hyper-V para comunicarse.
