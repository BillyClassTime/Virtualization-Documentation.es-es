...
- Volver a compilar el contenedor en función de la versión correcta de `mcr.microsoft.com/windows/nanoserver` o `mcr.microsoft.com/windows/servercore`
