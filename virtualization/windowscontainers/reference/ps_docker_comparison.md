...
En un esfuerzo por no duplicar la documentación de API disponible en Docker, aquí se muestra un vínculo a sus API de administración. Sus tutoriales son fantásticos.
