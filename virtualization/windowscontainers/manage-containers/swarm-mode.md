...
```
## Clústeres de sistemas operativos combinados Windows + Linux
...
### Inicialización de un clúster con sistemas operativos combinados Linux+Windows
...
### Implementación de servicios para un enjambre con sistemas operativos combinados
...
## Publicar puertos para los puntos de conexión de servicio
...
#### *Una red transparente existente puede bloquear inicialización de un enjambre o la creación de una red superpuesta* 
