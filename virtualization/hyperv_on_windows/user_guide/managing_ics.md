...
Los servicios de integración también se pueden habilitar y deshabilitar con PowerShell mediante la ejecución de [`Enable-VMIntegrationService`](https://technet.microsoft.com/es-es/library/hh848500.aspx) y [`Disable-VMIntegrationService`](https://technet.microsoft.com/es-es/library/hh848488.aspx).
...
> **Nota:** La deshabilitación de los servicios de integración puede afectar gravemente a la capacidad de los hosts de administrar la máquina virtual. Los servicios de integración deben habilitarse en el host y en el invitado para funcionar.
...
Ahora, si ejecuta de nuevo `ps -ef | hv`, descubrirá que todos los procesos `hv_kvp_daemon` desaparecieron.
