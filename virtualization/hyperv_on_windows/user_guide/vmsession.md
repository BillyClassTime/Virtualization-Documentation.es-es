...
> Nota: Si la sesión no se conecta, consulte [Solucionar problemas](vmsession.md#troubleshooting) para ver las posibles causas. 
...
Consulte los ejemplos de [GitHub](https://github.com/Microsoft/Virtualization-Documentation/search?l=powershell&q=-VMName+OR+-VMGuid&type=Code&utf8=%E2%9C%93).
